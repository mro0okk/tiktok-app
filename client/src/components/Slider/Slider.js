...
import SliderTopUser from "./SliderTopUser"
      ...
      <div className={clsx(style.slider, style.s_1)}>
        <div className={style.mainNav}>
          ...
          <Link
            ...
            onClick={() => setPageName(href)}
            className={clsx(style.mainNavHome, {
              [style.active]: pageName === `${originHref}/FollowPage`,
            })}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              fill="currentColor"
              className={clsx({
                [style.hide]: pageName === `${originHref}/FollowPage`,
              })}
              viewBox="0 0 16 16"
            >
        ...
        <div className={style.none}>
          <div className={style.mainNav}>
            ...
            <ButtonLogin className={clsx(style.btnLogin, style.none)} />
          </div>
        </div>
        <div className={style.mainNav}>
